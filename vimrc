...
augroup Vimrc
  ...
  autocmd BufRead *.pdf let _r = fnameescape(expand('%:r'))
  autocmd BufRead *.pdf exe 'e' _r.'_pdf.txt'
  autocmd BufRead *.pdf setl bt=nofile
  autocmd BufRead *.pdf exe 'sil r !pdftotext' _r.'.pdf -'
  autocmd BufRead *.pdf 1d
augroup end
